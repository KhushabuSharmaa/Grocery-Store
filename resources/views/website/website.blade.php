...
@section('content')
                ...
                <div class="tab-class text-center">
                    ...
                    <div class="tab-content">
                      @foreach($categories as $key => $category)
                        <div id="tab-{{$category->id}}" class="tab-pane fade {{$key == 0 ? 'show active' : ''}}">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                     ...
                                     @foreach($category->products as $data)
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <a href="{{route('shop_product_details', $data->id)}}">
                                                    <div class="rounded position-relative fruite-item">

                                                        <div class="first-item-box">
                                                            <div class="fruite-img">
                                                                <img src="{{ asset('storage/image/' . $data->image)}}" class="img-fluid w-100 rounded-top" alt="">
                                                            </div>
                                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">{{$data->category->categoryname}}</div>
                                                        </div>
                                                        
                                                        <div class="second-item-box p-2 border border-secondary border-top-0 rounded-bottom">
                                                            <div class="">
                                                                <h4>{{$data->product_name}}</h4>
                                                                <p>{{$data->short_description}}</p>
                                                                <div class="">
                                                                    <p class="text-dark fs-5 fw-bold mb-0">${{$data->mrp}} / {{$data->unit}}</p> <br>
                                                                    <a href="{{route('shop_product_details',$data->id)}}" class="btn border border-secondary rounded-pill px-5 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="row g-4">
                    @foreach($BestsellerProductsbox1 as $bestproduct)
                        <div class="col-lg-6 col-xl-4">
                            <div class="p-4 rounded bg-light bestseller-card">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <img src="{{ asset('storage/image/' . $bestproduct->image)}}" class="img-fluid rounded-circle w-100" alt="">
                                    </div>
                                    <div class="col-6">
                                        <a href="#" class="product-title">{{$bestproduct->product_name}}</a>
                                        ...
                                        <h4 class="mb-3">{{$bestproduct->mrp}}</h4>
                                        <a href="{{route('shop_product_details', $bestproduct->id)}}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    @foreach($BestsellerProductsbox2 as $bestproduct)
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="text-center bestseller-grid-card">
                                <img src="{{ asset('storage/image/' . $bestproduct->image)}}" class="img-fluid rounded" alt="">
                                <div class="py-4">
                                    <a href="#" class="product-title">{{$bestproduct->product_name}}</a>
