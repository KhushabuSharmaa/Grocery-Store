                    ...
                    <div class="row d-flex">
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="file" class="form-control mb-2" name="logo" id="logo" value="">
                          <img src="{{asset('web-setting/'.$data->logo ?? '')}}" alt="" style="height:60px; width:300px; border:1px solid secondary"> <br>

                          <label >Email</label>
                          <input type="email" class="form-control mb-2" name="email" value="{{$data->email ?? ''}}"/>

                          <label >Contact</label>
                          <input type="number" class="form-control mb-2" name="contact" value="{{$data->contact ?? ''}}"/>

                          <label>Address</label>
                          <input type="text" class="form-control mb-2" name="address" value="{{$data->address ?? ''}}">
