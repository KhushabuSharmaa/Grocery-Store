...
<div class="main-panel">
      ...
      <div class="card d-flex mt-5">
           <div>
                ...
                <h3 class="op-7 mb-2">Update Category</h3>
              </div>
      </div>
            <div class="row ">
              <div class="col-md-12 ">
                <div class="card">
                  ...
                  <form action="{{route('update.category', $editdata->id)}}" method="post">
                    @csrf
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            id="email2"
                            placeholder="Enter category" name="categoryname" value="{{$editdata->categoryname}}"
                          />
